...
from pyiri2016.iriweb import irisubgl
from numpy import arange, array, ceil, empty, floor, isnan, log10, meshgrid, \
    nan, tile, transpose, where
from numpy.ma import masked_where
from matplotlib.pyplot import cm, colorbar, figure, savefig, show
...
class IRI2016_2DProf(IRI2016Profile):
    ...
    def HeightVsTime(self, hrlim=[0., 24.], hrstp=1.):
    ...
    def LatVsFL(self, date=[2003,11,21], time=[23,15,0], gc=[-77.76,-11.95], \
        ...
        for fl in range(nfl):
            ...
            if len(ind[0]) > 0:
                ...
                outf, oarr = irisubgl(jf,jmag,year,mmdd,hour,
    ...
    def PlotLatVsFL(self):
        ...
        for ir in range(nrow):
            ...
            for ic in range(ncol):
                ...
                ipc = pn.pcolor(X, Y, Z_masked, cmap=cm.jet, vmax=vmax, vmin=vmin)
                cp = colorbar(ipc)
